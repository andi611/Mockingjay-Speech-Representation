# 🦜 Mockingjay
## Our Implementation is now moved into the new repo: [S3PRL toolkit](https://github.com/andi611/Self-Supervised-Speech-Pretraining-and-Representation-Learning)

---
* **IMPORTANT: Codes are now moved into the new open source project:** [S3PRL toolkit: Self-Supervised-Speech-Pretraining-and-Representation-Learning](https://github.com/andi611/Self-Supervised-Speech-Pretraining-and-Representation-Learning)
---
...
* Codes are now incoporated into the new toolkit: https://github.com/andi611/Self-Supervised-Speech-Pretraining-and-Representation-Learning
